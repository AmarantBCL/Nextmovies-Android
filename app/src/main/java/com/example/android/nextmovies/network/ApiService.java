...
public interface ApiService {
    @GET("{sort_method}?api_key=692a162b1d95c63d2cca4046b3e7f851")
    Single<MovieResponse> loadMovies(@Path("sort_method") String sort, @Query("page") int page,
                                     @Query("language") String lang);

    @GET("{movie_id}/videos?api_key=692a162b1d95c63d2cca4046b3e7f851")
    Single<TrailerResponse> loadTrailers(@Path("movie_id") int id, @Query("language") String lang);

    @GET("{movie_id}/reviews?api_key=692a162b1d95c63d2cca4046b3e7f851")
